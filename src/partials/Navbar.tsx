  ...
  <Section>
    <NavbarTwoColumns>
      <a href="/">
        <Logo
          icon={
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8 stroke-cyan-600 fill-cyan-600 mr-2">
      ...
      <NavMenu>
        ...
        <NavMenuItem href="https://github.com/maajix">GitHub</NavMenuItem>
        <NavMenuItem href="https://x.com/majix_de">Twitter</NavMenuItem>
      </NavMenu>
    </NavbarTwoColumns>
  </Section>
);
